...
if __name__ == "__main__":
    # Get base path from environment variable or default to TechHub directory
    base_path = os.getenv("TECHHUB_PATH", "/Users/craighubbard/Documents/VirtualStageAcademy/TechHub")
